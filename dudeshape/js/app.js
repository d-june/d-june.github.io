(() => {
    ...
    function increaseNumberAnimationStep(i, element, endNumber, step, sign) {
        if (i <= endNumber) {
            if (i === endNumber) element.innerText = i.toFixed(0) + sign; else {
    ...
    function initIncreaseNumberAnimation() {
        ...
        increaseNumberAnimationStep(0, sales, 2, .11, plus);
        increaseNumberAnimationStep(0, customars, 1.9, .11, plus);
    }
    ...
    let onMutate = function(mutationsList) {
        mutationsList.forEach((() => {
            if (advantagesContainer.classList.contains("_active")) initIncreaseNumberAnimation();
        }));
    };
