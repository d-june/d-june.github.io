(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".main-header__slider")) {
            new core(".main-header__slider", {
            ...
            new core(".trending-main__slider", {
                modules: [ Navigation, Pagination, Parallax, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".trending-main__dotts",
                    clickable: true
                },
                on: {}
            });
            new core(".reviews-main__slider", {
                modules: [ Navigation, Pagination, Parallax, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("form-middle-header__icon")) document.querySelector(".middle-header__container").classList.toggle("_active"); else if (!targetElement.closest(".middle-header__container") && document.querySelector(".form-middle-header._active")) document.querySelector(".middle-header__container").classList.remove("_active");
            if (targetElement.classList.contains("categories-form-header")) document.querySelector(".categories-form-header").classList.toggle("_active"); else if (!targetElement.closest(".categories-form-header") && document.querySelector(".categories-form-header._active")) document.querySelector(".categories-form-header").classList.remove("_active");
            if (targetElement.classList.contains("language-top-header")) document.querySelector(".language-top-header").classList.toggle("_active"); else if (!targetElement.closest(".language-top-header") && document.querySelector(".language-top-header._active")) document.querySelector(".language-top-header").classList.remove("_active");
            ...
            if (targetElement.classList.contains("cart-middle-header__icon") || targetElement.closest(".cart-middle-header__icon")) {
                if (document.querySelector(".cart-list").children.length > 0) document.querySelector(".cart-middle-header").classList.toggle("_active-cart");
                e.preventDefault();
            } else if (!targetElement.closest(".cart-middle-header") && !targetElement.classList.contains("product__shop")) document.querySelector(".cart-middle-header").classList.remove("_active-cart");
    ...
    function filterProducts() {
        ...
        document.querySelector(".trending-main__list").addEventListener("click", (event => {
            ...
            filterTrend.forEach((elem => {
                elem.classList.remove("hide");
                if (!elem.classList.contains(filterClass) && "top" !== filterClass) elem.classList.add("hide");
            }));
        }));
    }
    filterProducts();
