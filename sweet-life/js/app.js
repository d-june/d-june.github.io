(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".top-main__slider")) new core(".top-main__slider", {
            ...
            if (document.querySelector(".excursions-main__slider")) new core(".excursions-main__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".excursions-main__pagination",
                    clickable: true,
                    type: "progressbar"
                },
                navigation: {
            ...
            if (document.querySelector(".reviews-main__slider")) new core(".reviews-main__slider", {
                modules: [ Navigation, Autoplay, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.5,
        ...
        if (calculate) {
            ...
            function calculateOrder() {
                ...
                decorSelects.forEach((select => {
                    if (select.selected) {
                        ...
                        if (select.value) selectsContent = `${selectsContent} ${select.value} <br>`;
                ...
                decorCheckboxes.forEach((checkbox => {
                    ...
                    if (checkbox.value) checkboxesContent = `${checkboxesContent} ${checkbox.value} <br>`;
                }));
            ...
            function inputChecked() {
                ...
                if (cakeChecked) cakeChecked.parentNode.classList.add("active-popup");
                if (creamChecked) creamChecked.parentNode.classList.add("active-popup");
            }
            ...
            function printTotalWeight(sumOfWeightSelectedOptions) {
                const cake = document.querySelector(".spollers-constructor-main__cake input:checked"), cream = document.querySelector(".spollers-constructor-main__cream input:checked"), totalWeight = document.querySelector(".total-constructor-main__weight"), totalWeightPopup = document.querySelector(".total-form-popup__weight"), totalCakeContent = document.querySelector(".total-form-popup__content_cake"), totalCreamContent = document.querySelector(".total-form-popup__content_cream");
                const cakeWeight = Number(cake.dataset.weight), creamWeight = Number(cream.dataset.weight), cakeContent = cake.value, creamContent = cream.value;
            ...
            function printTotalCheckboxAndSelectsContent(checkboxesContent, selectsContent) {
                const totalContentCheckbox = document.querySelector(".total-form-popup__content_checkbox"), totalContentSelect = document.querySelector(".total-form-popup__content_select");
        ...
        datepicker(".calendar-order-ready", {
            formatter: (input, date, instance) => {
                const value = date.toLocaleDateString();
                input.value = value;
            },
            minDate: new Date((new Date).getTime() + 2592e5),
        ...
        datepicker(".calendar-constructor", {
            formatter: (input, date, instance) => {
                const value = date.toLocaleDateString();
                input.value = value;
            },
        ...
        if (orderProduct) orderProduct.addEventListener("click", (e => {
            let target = e.target;
            if (target.classList.contains("product__buy")) {
                const popupProductBody = target.parentNode.parentNode, popupProductPrice = popupProductBody.querySelector(".product__price span").innerText, popupProductWeight = popupProductBody.querySelector(".product__weight span").innerText, productName = popupProductBody.querySelector(".product__title").innerText, orderPrice = document.querySelector("#order-ready-cost span"), orderWeight = document.querySelector("#order-ready-weight span"), orderText = document.querySelector("#order-ready-text span");
