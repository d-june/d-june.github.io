(() => {
    ...
    window.onload = function() {
        ...
        let preloaderText = document.querySelector(".preloader__text");
        setTimeout((function() {
            preloaderText.classList.add("text-visible");
        }), 500);
        setTimeout((function() {
    ...
    let preloader_link = document.querySelector(".hero__button");
    let header = document.querySelector(".header__container");
    let heroImage = document.querySelector(".hero__image-ibg");
    setTimeout((function() {
    ...
    setTimeout((function() {
        preloader_link.classList.add("link-visible");
    }), 14e3);
    const textTitle = [ "Меня зовут Катя" ];
    const textSubtitle = [ "Я - начинающий Frontend-разработчик." ];
    let htmlOutTitle = document.querySelector(".hero__title");
    let htmlOutSubtitle = document.querySelector(".hero__sub-title");
    function typeText(text, htmlOut) {
        let line = 0;
        let count = 0;
        let out = "";
        function typeLine() {
    ...
    setTimeout((function() {
        typeText(textTitle, htmlOutTitle);
    }), 5500);
    setTimeout((function() {
        typeText(textSubtitle, htmlOutSubtitle);
    }), 8500);
